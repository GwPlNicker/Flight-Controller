...
plt.subplot(2, 1, 1)
plt.plot(propeller_speed_history, label='Current Propeller Speed', color='b')
plt.plot(desired_propeller_speed_history, label='Desired Propeller Speed', color='r', linestyle='--')
...
# График высоты
plt.subplot(2, 1, 2)
plt.plot(height_history, label='Current Height', color='g')
plt.plot(desired_height_history, label='Desired Height', color='orange', linestyle='--')
